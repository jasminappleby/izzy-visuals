...
function Events() {
  ...
  const isSubPage = location.pathname !== '/gallery/events';
  ...
  return (
    <div className="page-content">
      ...
      <GalleryCarousel 
        title="Nightlife" 
        link="/gallery/events/nightlife"
        images={Array.from({ length: 4 }, (_, i) => `/images/events/nightlife/nightlife-${i + 1}.jpg`)}
      />

      <GalleryCarousel 
        title="Birthdays" 
        link="/gallery/events/birthdays"
        images={Array.from({ length: 16 }, (_, i) => `/images/events/birthday/birthday-${i + 1}.jpg`)}
      />

      <GalleryCarousel 
        title="Private Events" 
        link="/gallery/events/private"
        images={Array.from({ length: 16 }, (_, i) => `/images/events/private/private-${i + 1}.jpg`)}
      />
